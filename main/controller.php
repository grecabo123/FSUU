...
if(isset($token["error"]) != "invalid_grant"){
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        header("location: temporary");
        exit();
    }
    else{
        $type = "user";
        $sql = "INSERT INTO profile(first_name,middle_name,last_name,age,gender,Birthdate,Birthplace,Email,contact,url_img) VALUES ('$fname',null,'$lname',null,null,null,null,'$email',null,'$pic')";
        if (mysqli_query($conn,$sql) === TRUE) {
            ...
            if (mysqli_query($conn,$account_type) === TRUE) {
                $student = "INSERT INTO student(course,Year,father_name,mother_name,parent_address,ProfileID_fk) VALUES (null,null,null,null,null,$id)";
